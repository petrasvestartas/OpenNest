...
Every component has its own tutorial page with a worked example and **downloadable Grasshopper files** — browse
them under the **Components** section in the sidebar. To get started, install the plugin from the Rhino Package
Manager (see **Install** below) and drop the components onto your canvas.
