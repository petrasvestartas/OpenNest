...
// a and b must share dims (the caller pads the item to tray size first). Used by corr3 below; the hot
// path uses the Correlator (correlator.hpp), which caches FFTs across orientations.
