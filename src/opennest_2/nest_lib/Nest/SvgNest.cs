      ...
      return b.distance;
        ...
        public static NFP simplifyFunction(NFP polygon, bool inside, SvgNestConfig config)
        {
            ...
            //if (straightened)
            {
                ...
                var Ac = clipper_util.ScaleUpPaths(offset, 10000000);
                var Bc = clipper_util.ScaleUpPaths(polygon, 10000000);
            ...
            //Rhino.RhinoDoc.ActiveDoc.Objects.AddPolyline(offset.ToPolyline());
            return offset;
        ...
        public static IntPoint[] svgToClipper2(NFP polygon, double? scale = null)
        {
            ...
            var d = clipper_util.ScaleUpPaths(polygon, scale == null ? Config.clipperScale : scale.Value);
            return d.ToArray();
        ...
        public static ClipperLib.IntPoint[] svgToClipper(NFP polygon)
        {
            ...
            var d = clipper_util.ScaleUpPaths(polygon, Config.clipperScale);
            return d.ToArray();
